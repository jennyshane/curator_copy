...
#-------Load data, initial image, start----------
    ...
    def create_actions(self):
        ...
        self.play_act=QAction(QIcon("icons/play.png"), "Play", self)
        self.play_act.triggered.connect(self.play)
        self.pause_act=QAction(QIcon("icons/pause.png"), "Pause", self)
        self.pause_act.triggered.connect(self.pause)
        self.next_frame_act=QAction(QIcon("icons/rarrow.png"), "Forward", self)
        self.next_frame_act.triggered.connect(self.next_img)
        self.prev_frame_act=QAction(QIcon("icons/larrow.png"), "Back", self)
        self.prev_frame_act.triggered.connect( self.prev_img)
        self.next_frame10x_act=QAction(QIcon("icons/rarrows.png"), "Forward", self)
        self.next_frame10x_act.triggered.connect(self.next_img)
        self.prev_frame10x_act=QAction(QIcon("icons/larrows.png"), "Back", self)
        self.prev_frame10x_act.triggered.connect(self.prev_img)
        self.speed_up_act=QAction(QIcon("icons/uarrow.png"), "Speed Up", self)
        self.speed_up_act.triggered.connect( self.speed_up)
        self.speed_down_act=QAction(QIcon("icons/darrow.png"), "Speed Down", self)
        self.speed_down_act.triggered.connect(self.speed_down)
        #Create all actions needed for editing
        self.delete_act=QAction(QIcon("icons/close.png"), "Delete selection", self)
        self.delete_act.triggered.connect( self.deleteframes)
        self.tag_act=QAction(QIcon("icons/flag.png"), "Tag selection", self)
        self.tag_act.triggered.connect(self.tagframes) #TODO
        self.lbracket_act=QAction(QIcon("icons/lbracket.png"), "begin selection", self)
        self.lbracket_act.triggered.connect(self.bracketframes) 
        self.rbracket_act=QAction(QIcon("icons/rbracket.png"), "end selection", self)
        self.rbracket_act.triggered.connect(self.bracketframes) 
        self.undo_act=QAction(QIcon("icons/larrow.png"), "undo edit", self)
        self.undo_act.triggered.connect( self.undo) 
        self.redo_act=QAction(QIcon("icons/rarrow.png"), "redo edit", self)
